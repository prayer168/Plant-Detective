...
- 結果：6 個 HTML 頁面、61 張植物卡、21 張 IMAGE 2.0 PNG 資產。
...
本次擴充後以 `scripts/browser-verify.mjs` 再次完整重測；驗證器會強制載入並解碼所有延遲載入圖片，再檢查 61 張卡、13 張植物圖版、圖片載入、標題層級與水平溢出。

## 視覺目視檢查

- 桌機：首頁封面、61 種植物首尾圖版、葉子形態、兩個活動頁與種子頁皆檢查；標題、圖像、提示框、卡片未重疊。
