...
- 桌機：首頁封面、61 種植物首尾圖版、葉子形態、果實種子頁與兩個五感遊戲頁皆檢查；標題、圖像、總覽表、提示框與卡片未重疊。
...
- 五感遊戲（一）與（二）的列印媒體樣式會隱藏導覽與高耗墨步驟大圖，讓 8 套教案依遊戲分頁並保留可書寫的學習單內容。
...
- 公開頁面實測為 61 張不重複植物卡、13 張植物圖版、5 張葉子形態圖、6 張果實種子分類圖、8 套五感遊戲與 8 張遊戲步驟圖。
